...
const controlList = () => {
  ...
  // Өмнө харагдаж байсан найрлагуудыг дэлгэцээс зайлуулна
  listView.clearItems();

  // Уг модель рүү одоо харагдаж байгаа жорны бүх найрлагыг авч хийнэ
  state.recipe.ingredients.forEach((n) => {
    // Тухайн найрлагыг модел рүү хийнэ
    const item = state.list.addItem(n);

    // Тухайн найрлагыг дэлгэцэнд хэвлэнэ
